...
class ChatPlayerConnectListModel {
  int? success;
  int? code;
  String? message;
  List<ChatPlayerBodyBody>? body;

  ChatPlayerConnectListModel(
      {this.success, this.code, this.message, this.body});

  ChatPlayerConnectListModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    if (json['body'] != null) {
      body = <ChatPlayerBodyBody>[];
      json['body'].forEach((v) {
        body!.add(new ChatPlayerBodyBody.fromJson(v));
      });
    }
  }
...
class ChatPlayerBodyBody {
  ...
  ChatPlayerBodyBody.fromJson(Map<String, dynamic> json) {
    id = json['id'];
