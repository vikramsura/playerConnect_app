class SearchUserModel {
  ...
  int? code;
  String? message;
  List<SearchUserModelBody>? body;

  SearchUserModel({this.success, this.code, this.message, this.body});
  ...
  SearchUserModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['body'] != null) {
      body = <SearchUserModelBody>[];
      json['body'].forEach((v) {
        body!.add(SearchUserModelBody.fromJson(v));
      });
    }
  }
...
class SearchUserModelBody {
  ...
  SearchUserModelBody.fromJson(Map<String, dynamic> json) {
    id = json['id'];
